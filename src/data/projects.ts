...
export const ALL_PROJECTS: ProjectData[] = [
  ...
  },
  {
    ...
    tagline:
      'A high-performance, Multimodal AI Desktop Assistant powered by Groq, LangChain, and FastAPI.',
    ...
    detailedOverview:
      "J.A.R.V.I.S is a high-performance Multimodal AI Desktop Assistant inspired by Iron Man's J.A.R.V.I.S. Utilizing Groq and Llama 3 models, it offers real-time voice synthesis and interactive web UI panels, making automation accessible through natural language controls.",
    problemStatement:
      'Traditional desktop automation tools require complex scripting languages or static macro programs, which lack adaptability to dynamic user intents or voice controls.',
    quote:
      'Creating a zero-latency desktop assistant meant combining localized OS triggers with blazing fast LLM inferences at sub-400ms levels.',
    solution:
      'I designed a system integrating FastAPI web hooks, customized PowerShell task scripts, memory vector embeddings, and multi-threaded edge-TTS verbal feedbacks.',
    outcomes:
      'Successfully deployed a modular system capable of opening applications, querying Vector databases, and executing system telemetry commands seamlessly.',
