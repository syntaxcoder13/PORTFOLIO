      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center relative w-full lg:pl-16">
            ...
            {/* Contact Cards Stack */}
            <ul className="flex flex-col gap-4 w-full pt-4 lg:pt-0" role="list">
              {CONTACT_METHODS.map((method, i) => {
                const Icon = method.icon;
                return (
                  <li key={method.id}>
                    <FadeIn delay={0.1 + i * 0.08} y={30} duration={0.6}>
                      <a
                        href={method.href}
                        target="_blank"
        ...
        <FadeIn delay={0.5} y={15}>
          <footer className="flex flex-col items-center gap-3 text-center sm:flex-row sm:justify-between select-none mt-8">
