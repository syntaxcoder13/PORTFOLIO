...
import { ALL_ACHIEVEMENTS, AchievementData as Achievement } from '../data/achievements';
import AllAchievementsOverlay from './AllAchievementsOverlay';
...
const AchievementCard = ({
  ...
  // Select colored border for the back card depending on the type
  const backBorderClass = achievement.id === 'hack-1' || achievement.id === 'techxpression'
  ...
  const accentColorClass = achievement.id === 'hack-1' || achievement.id === 'techxpression'
    ? 'text-emerald-700'
    : achievement.id === 'horizon'
      ? 'text-amber-700'
      : achievement.id === 'aavishkar'
      ...
      >
        ...
        >
          ...
          <div className="flex-1 flex gap-6 justify-between items-center py-4">
            ...
            {/* Right Side Visual Block for Specific Achievements on Desktop */}
            {achievement.id === 'aavishkar' && (
              <div className="hidden md:flex w-44 flex-col justify-between rounded-xl border border-neutral-200 bg-neutral-50/70 p-4 relative overflow-hidden shrink-0 select-none">
                ...
                <div className="flex flex-col gap-2.5">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-neutral-800 font-mono leading-relaxed mt-0.5">
                      Arduino / ESP32
                    </span>
                  </div>
          ...
          {/* Bottom Panel: Subtitle/Meta Info & Buttons */}
...
const AchievementCardBack = ({
  ...
  return (
    <div
      className={`absolute inset-0 w-full h-full rounded-2xl border bg-[#fdfdfd] p-6 sm:p-8 flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 ${backBorderClass}`}
      style={{
    ...
    >
      {/* Top Bar */}
      <div className="flex items-center justify-between pb-3.5 border-b border-neutral-200/60 select-none">
        <span className={`text-[10px] font-bold uppercase tracking-widest ${accentColorClass}`}>
          Problem Statement
        </span>
        <span className="font-mono text-xs font-semibold text-neutral-400">
          / {displayNumber}
...
const AchievementsSection = () => {
  ...
  useEffect(() => {
    ...
    // 1. Left Vertical Gutter Gimmick
    ...
    // 2. Left-aligned Typography Column
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="hidden xl:flex absolute -left-14 xl:-left-16 top-1/2 -translate-y-1/2 flex-col items-center gap-6 pointer-events-none select-none">
          ...
          <div
            ref={gutterLineRef}
            className="h-24 w-px bg-neutral-200 relative scale-y-0"
          >
        ...
        <div className="mb-16 sm:mb-20 md:mb-24 flex flex-col items-start gap-5 text-left xl:pl-12">
          ...
          <div
            ref={lineRef}
            className="w-12 h-[2px] bg-neutral-200 my-2 opacity-0"
          />
        ...
        <div
          ...
          className="relative z-10 grid grid-cols-1 md:grid-cols-6 gap-6 xl:pl-12"
        >
